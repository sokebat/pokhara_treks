...
const TripMobileBar = () => (
  <nav
    ...
    className="fixed inset-x-0 bottom-0 z-40 grid grid-cols-3 border-t border-primary-foreground/15 bg-primary pb-[env(safe-area-inset-bottom)] lg:hidden"
  >
    ...
    <a
      ...
      className="flex flex-col items-center gap-0.5 border-r border-primary-foreground/15 py-2 text-[11px] font-semibold text-primary-foreground"
    >
