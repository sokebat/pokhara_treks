import { TbArrowRight, TbCompass, TbHome } from "react-icons/tb";
...
import { notFoundTrails } from "../constant/trails";
          ...
          <div className="relative grid items-center gap-8 py-12 sm:py-16 lg:grid-cols-2 lg:gap-12 lg:py-20">
            <div>
              ...
              <p className="mt-4 max-w-lg text-primary-foreground/80">
                The page you&apos;re looking for has moved, been renamed, or was
                never on the map. We&apos;ll get you back to a path that does.
              </p>
      ...
      <section className="bg-background py-10 sm:py-12">
        <Container>
          ...
          <div className="mt-6 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            {notFoundTrails.map(({ href, label, description, icon: Icon }) => (
              <Link
                key={href}
                href={href}
