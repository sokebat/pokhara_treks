...
export const remoteRegions: TrekkingRegion[] = [
  ...
  },
  {
    ...
    imageAlt: "High glacier country on the Dhaulagiri circuit in western Nepal",
    location: "Dhaulagiri · Hidden Valley",
    typicalDuration: "14–18 days",
    facts: [
      {
        label: "Highest point",
        value: "French Pass 5,360 m",
        icon: TbMountain,
      },
      {
        label: "Best season",
        value: "Apr–May · Sep–Oct",
        icon: TbCalendarEvent,
      },
  ...
  },
  {
    ...
    icon: TbMountain,
    image: WOMEN_TREK_PHOTO,
    imageAlt: "Eastern Himalayan ridges on the approach to Kanchenjunga",
    ...
    facts: [
      ...
      {
        label: "Permits",
        value: "Restricted area · KCAP · TIMS",
        icon: TbFileText,
      },
