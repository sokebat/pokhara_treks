...
export const heliTours: HeliTour[] = [
  ...
  },
  {
    ...
    href: "/tours/poonhill-ghandruk-helicopter-tour",
    flight: "1 hour",
    landsAt: "3,210 m",
    departs: "06:45",
  ...
  },
  {
    ...
    href: "/tours/kapuche-helicopter-tour",
    flight: "1 hr 10 min",
    landsAt: "2,546 m",
    departs: "07:30",
  ...
  },
  {
    ...
    href: "/tours/kori-helicopter-tour",
    flight: "50 minutes",
    landsAt: "3,800 m",
    departs: "07:00",
    location: "Kori Himal",
  ...
  },
  {
    ...
    href: "/tours/muktinath-helicopter-tour",
    flight: "2 hours",
    landsAt: "3,710 m",
    departs: "07:00",
    location: "Muktinath",
  ...
  },
  {
    ...
    href: "/tours/heli-tour-north-annapurna-base-camp",
    flight: "1 hour",
    landsAt: "4,190 m",
    departs: "06:30",
  ...
  },
  {
    ...
    href: "/tours/upper-mustang-helicopter-tour",
    flight: "2 hr 30 min",
    landsAt: "3,840 m",
    departs: "07:00",
  ...
  },
  {
    ...
    href: "/tours/manang-helicopter-tour",
    flight: "1 hr 30 min",
    landsAt: "3,540 m",
    departs: "07:00",
    location: "Manang",
  ...
  },
  {
    ...
    href: "/tours/everest-helicopter-tour",
    flight: "4 hours",
    landsAt: "5,545 m",
    departs: "06:00",
  ...
  },
  {
    ...
    href: "/tours/rescue-flight-medical-evacuation-and-other-services",
    flight: "On demand",
...
const featuredHrefs = [
  "/tours/annapurna-base-camp-heli-landing-tour",
  "/tours/mardi-heli-tour",
  "/tours/poonhill-ghandruk-helicopter-tour",
  "/tours/kapuche-helicopter-tour",
] as const;
